...
- An `agent-browser` running *inside* a DevTool terminal (e.g., Codex driving some other browser) is unrelated to the one driving DevTool itself — they're independent processes.
